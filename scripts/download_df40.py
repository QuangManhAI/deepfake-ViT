...
Cách chạy:
  .venv/bin/python scripts/download_df40.py                         # tất cả
  .venv/bin/python scripts/download_df40.py --only real_ffpp,real_celebdf,dataset_json
  .venv/bin/python scripts/download_df40.py --skip test_data,train_data
