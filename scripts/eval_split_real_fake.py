...
Đọc feature memmap đã extract (outputs/features/{tag}_{model}.mmap) — không extract lại.
...
Chạy:
  .venv/bin/python scripts/eval_split_real_fake.py --model vit --tag test_data
  .venv/bin/python scripts/eval_split_real_fake.py --model cnn --tag test_data
"""
import argparse
import json
import os
