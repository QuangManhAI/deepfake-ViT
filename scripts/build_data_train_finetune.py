...
Cách dùng:
  .venv/bin/python scripts/build_data_train_finetune.py \
      --extract data_train_local --out data_train \
      --real data/real-root/Celeb-DF-v2/Celeb-real/frames \
      --n-real 1000 --seed 42
"""
import argparse
import csv
...
def main():
    ...
    ap.add_argument("--real", default="data/real-root/Celeb-DF-v2/Celeb-real/frames")
