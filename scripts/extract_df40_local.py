...
data/DF40_train/ (đã tải về). Với mỗi method:
...
Cách dùng:
  .venv/bin/python scripts/extract_df40_local.py \
      --zip-dir data/DF40_train --out data_train_local \
      --pairs 30 --seed 42 \
...
def main():
    ...
    ap.add_argument("--zip-dir", default="data/DF40_train")
