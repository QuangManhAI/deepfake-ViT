...
Output: data/real-root/Celeb-DF-v2/<sub>/frames/<video_id>/<frame>.png
  (khớp cấu trúc đường dẫn trong JSON: deepfakes_detection_datasets/ -> data/real-root/)

Chạy:
  .venv/bin/python scripts/extract_celeb_frames.py            # trích tất cả
  .venv/bin/python scripts/extract_celeb_frames.py --dry-run  # chỉ báo kế hoạch
"""
import argparse
import glob
import json
