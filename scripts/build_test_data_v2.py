...
REAL (identity-unique, 1 frame/người):
  - Celeb-DF: 178 identity (data/real-root/Celeb-DF-v2)
...
Chạy:
  .venv/bin/python scripts/build_test_data_v2.py --dry-run   # chỉ đếm
  .venv/bin/python scripts/build_test_data_v2.py             # build + copy
"""
import argparse
import csv
import glob
...
CELEB_REAL = "data/real-root/Celeb-DF-v2"
