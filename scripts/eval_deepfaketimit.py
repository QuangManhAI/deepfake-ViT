...
def main():
    ...
    parser.add_argument("--vit-model", default="models/dinov3-vits16plus-pretrain-lvd1689m/model-3.safetensors")
    parser.add_argument("--cnn-model", default="models/dinov3_next_cnn/model-2.safetensors")
    parser.add_argument("--output", default="outputs/benchmark/deepfaketimit_report.json")
