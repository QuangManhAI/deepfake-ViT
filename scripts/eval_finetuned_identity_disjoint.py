...
so được với outputs/eval/identity_disjoint_v3_vit.json (baseline).

Chạy (trên mac mini sau khi finetune xong):
  .venv/bin/python scripts/eval_finetuned_identity_disjoint.py
"""
import argparse
import csv
import json
...
CKPT = "outputs/finetune/vit_finetuned.pt"
ROOT = "test_data_v3"
...
def main():
    ...
    ap.add_argument("--output", default="outputs/eval/finetuned_identity_disjoint_v3.json")
