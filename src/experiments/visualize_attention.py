...
Output: experiments/plots/attention/<name>_<layer>.png
"""
import argparse
import glob
import os
...
def main():
    ...
    parser.add_argument("--model", default="experiments/checkpoints/weights/dinov3-vits16plus-pretrain-lvd1689m/model-3.safetensors")
    ...
    parser.add_argument("--output-dir", default="experiments/plots/attention")
