...
Chạy:
  .venv/bin/python src/eval/eval_real_fake_separate.py --model vit --tag test_data_v2
  .venv/bin/python src/eval/eval_real_fake_separate.py --model cnn --tag test_data_v2
