...
Chạy:
  .venv/bin/python src/eval/eval_identity_disjoint.py --model vit --tag test_data_v2
  .venv/bin/python src/eval/eval_identity_disjoint.py --model cnn --tag test_data_v2
"""
import argparse
import csv
import gc
...
def main():
    ...
    cache_tr = f"experiments/results/features/{args.tag}_{args.model}.mmap"
    cache_te = f"experiments/results/features/{args.tag}_{args.model}_test.mmap"
