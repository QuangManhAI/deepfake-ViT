...
Chạy:
  .venv/bin/python src/eval/eval_challenge.py --labels-only
  .venv/bin/python src/eval/eval_challenge.py --limit-train 2000 --limit-test 400   # smoke test
  .venv/bin/python src/eval/eval_challenge.py                                       # full
"""
import argparse
import csv
import os
...
def main():
    ...
    ap.add_argument("--output", default="experiments/results/challenge_report.json")
