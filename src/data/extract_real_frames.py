...
Chạy:
  .venv/bin/python src/data/extract_real_frames.py \
      --videos data/raw/real-root/original_sequences/youtube/c23/videos/585.mp4 \
      --out data/raw/real-root/frames/ff++/585 \
      --step 6 --size 256
  # nhiều video:
  find data/raw/real-root/original_sequences/youtube/c23/videos -name '*.mp4' | \
    head -50 | xargs -I{} .venv/bin/python src/data/extract_real_frames.py --videos {} --out data/raw/real-root/frames/ff++
"""
import argparse
import os
import subprocess
